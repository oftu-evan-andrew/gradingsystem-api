...
class ClassStandingResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [ 
            ...
            'project_score' => $this->project_score !== null ? (float) $this->project_score : null,
            'major_exam_score' => $this->major_exam_score !== null ? (float) $this->major_exam_score : null,
